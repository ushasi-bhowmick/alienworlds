...
Since i used the hpc server to actually evaluate the LC, I needed a separate function to build the 
animation. Since realistic distance and size estimates do not show up well in the animation,
I had to scale down the animation much further than i scaled down the LC. But at least it looks good!

"""

#Initialize the simulation and declare the planets
#The orbits have been reduced by square roots, coz otherwise everything was too far apart to be 
#appreciated
...
#simulate the transit and read the LC file generated by the server.
